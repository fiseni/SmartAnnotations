...
- <strong>Required</strong> attribute - <sub><sup>AllowEmptyStrings, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>Display</strong> attribute - <sub><sup>Order, Name, ShortName, Description, Prompt, GroupName, AutogeneratedField, AutogeneratedFilter, ResourceType.</sup></sub>
- <strong>DisplayFormat</strong> attribute - <sub><sup>ApplyFormatInEditMode, ConvertEmptyStringToNull, HtmlEncode, DataFormatString, NullDisplayText, ResourceType.</sup></sub>
- <strong>StringLength</strong> attribute - <sub><sup>MinimumLength, MaximumLength, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>Max</strong> attribute - <sub><sup>Length, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>Min</strong> attribute - <sub><sup>Length, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>Compare</strong> attribute - <sub><sup>OtherProperty, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>Range</strong> attribute - <sub><sup>Minimum, Maximum, OperandType, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>DataType</strong> attribute - <sub><sup>DataType, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>Email</strong> attribute - <sub><sup>ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>CreditCard</strong> attribute - <sub><sup>ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>Phone</strong> attribute - <sub><sup>ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
- <strong>Url</strong> attribute - <sub><sup>ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.</sup></sub>
