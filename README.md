...
- ReadOnly attribute.
- Required attribute - AllowEmptyStrings, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- Display attribute - Order, Name, ShortName, Description, Prompt, GroupName, AutogeneratedField, AutogeneratedFilter, ResourceType.
- DisplayFormat attribute - ApplyFormatInEditMode, ConvertEmptyStringToNull, HtmlEncode, DataFormatString, NullDisplayText, ResourceType.
- StringLength attribute - MinimumLength, MaximumLength, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- Max attribute - Length, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- Min attribute - Length, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- Compare attribute - OtherProperty, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- Range attribute - Minimum, Maximum, OperandType, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- DataType attribute - DataType, ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- Email attribute - ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- CreditCard attribute - ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- Phone attribute - ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
- Url attribute - ErrorMessage, ErrorMessageResourceType, and ErrorMessageResourceName.
